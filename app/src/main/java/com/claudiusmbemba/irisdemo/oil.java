...
public class oil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle("Engine Oil Pressure");

        dynamicToolbarColor();

        toolbarTextAppernce();
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab8);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(oil.this,MapsActivity.class);
    ...
    private void sendToLogin() { //funtion
        ...
        mGoogleSignInClient.signOut().addOnCompleteListener(/*CURRENT CLASS */oil.this,
