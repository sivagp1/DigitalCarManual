...
public class fog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle("Front Fog Lamp");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(fog.this,MapsActivity.class);
    ...
    private void sendToLogin() { //funtion
        ...
        mGoogleSignInClient.signOut().addOnCompleteListener(/*CURRENT CLASS */fog.this,
