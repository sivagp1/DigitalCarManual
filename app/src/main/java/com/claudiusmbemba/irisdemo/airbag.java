...
public class airbag extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle("Air Bag");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(airbag.this,MapsActivity.class);
    ...
    private void sendToLogin() { //funtion
        ...
        mGoogleSignInClient.signOut().addOnCompleteListener(/*CURRENT CLASS */airbag.this,
