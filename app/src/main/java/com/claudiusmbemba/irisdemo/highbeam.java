...
public class highbeam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_highbeam);
        ...
        collapsingToolbarLayout.setTitle("High Beam");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(highbeam.this,MapsActivity.class);
    ...
    private void sendToLogin() { //funtion
        ...
        mGoogleSignInClient.signOut().addOnCompleteListener(/*CURRENT CLASS */highbeam.this,
