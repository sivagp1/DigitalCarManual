...
public class steering extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle("Power Steering");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(steering.this,MapsActivity.class);
    ...
    private void sendToLogin() { //funtion
        ...
        mGoogleSignInClient.signOut().addOnCompleteListener(/*CURRENT CLASS */steering.this,
